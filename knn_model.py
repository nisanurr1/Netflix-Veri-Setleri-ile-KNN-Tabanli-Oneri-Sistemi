...
# burada dah önce oluşturduğumuz TF-IDF vektörlerini knn_model.py dosyasına aktarıyoruz.
...
# kelime yapıları ne kadar benzerse cosine similarity o akdar yüksek çıkar.
...
#print("Film KNN modeli oluşturuldu.")
#print("Dizi KNN modeli oluşturuldu.")
